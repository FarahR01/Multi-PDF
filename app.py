...
def get_vectorstore(text_chunks):
    try:
        embeddings = OpenAIEmbeddings()  # You can also use HuggingFaceInstructEmbeddings
...
def get_conversation_chain(vectorstore):
    try:
        llm = ChatOpenAI()  # or use HuggingFaceHub if needed
...
def main():
    load_dotenv()
    st.set_page_config(page_title="Multi-PDF", page_icon=":M:")
